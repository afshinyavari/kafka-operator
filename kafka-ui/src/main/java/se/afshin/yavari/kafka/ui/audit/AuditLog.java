package se.afshin.yavari.kafka.ui.audit;
...
/**
 * Structured audit log for write operations issued through the UI.
 *
 * Each entry is one JSON line at INFO level on the dedicated logger
 * {@code kafka-ui.audit}. The fields are intentionally flat so the line can be
...
public class AuditLog {
    ...
    private static final Logger LOG = Logger.getLogger("kafka-ui.audit");
